# ╔═══════════════════════════════════════════════════════════╗
# ║  红创科技多物理场仿真平台                                  ║
# ║  算例: AAC墙体拟静力试验 — W-04 薄墙格构                    ║
# ║  规范: JGJ/T 101-2015                                      ║
# ║  构造: 格构 3600×3600×200mm, 无构造柱, 分布式芯柱          ║
# ╚═══════════════════════════════════════════════════════════╝
#
# W-04 与 W-03 对比: 厚度从 240mm 减至 200mm
# 减薄效应: 平面外刚度降低 42% (200/240)³
#           平面内等效刚度按厚度比折减: E_eff = E × 200/240
...
[Materials]
  ...
  [elasticity]
    ...
    youngs_modulus = 1.46e9     # E_eff = 1.75 × 200/240 = 1.46 GPa
    poissons_ratio = 0.20
  []
  [strain]
...
[Outputs]
  file_base = outputs/aac_wall_tests/w04_thin_pseudo_static
  exodus = true
  csv = true
[]
