...
**YOU ARE IN: `demo/polecats/shiny/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/demo/` (rig root) or other directories
...
**Your mail address:** `demo/polecats/shiny`
**Your rig:** demo
**Your Witness:** `demo/witness`
...
| Ask Witness for help | `gt mail send demo/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`demo/witness`) when:
...
```bash
gt mail send demo/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
